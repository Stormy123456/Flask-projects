...
function toggleSidenav() {
    ...
    }, 100), sidenav.classList.remove("bg-white")) : (body.classList.add(className), sidenav.classList.add("bg-white"), sidenav.classList.remove("bg-white"), iconSidenav.classList.remove("d-none"))
}
